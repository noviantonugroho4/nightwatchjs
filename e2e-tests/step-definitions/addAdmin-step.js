...
When(/^user add user on admin page$/, () => {
    const navbar = client.page.left_menu();
    navbar.expect.section('@left_menu').to.be.visible;

    const admin = navbar.section.left_menu
    admin.expect.element('@admin_btn').to.be.visible;
